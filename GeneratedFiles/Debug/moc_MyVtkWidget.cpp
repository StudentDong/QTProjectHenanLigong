...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myVtkWidget_t, stringdata) + ofs \
...
const QMetaObject myVtkWidget::staticMetaObject = {
    { &QVTKWidget::staticMetaObject, qt_meta_stringdata_myVtkWidget.data,
...
void *myVtkWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myVtkWidget.stringdata))
